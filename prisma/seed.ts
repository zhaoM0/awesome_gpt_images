...
async function main() {
  // Real prompts from the images directory
  const prompts = [
    {
      id: '1',
      ...
      images: {
        create: [
          { url: '/prompts/01_japanese_school.png', model: 'DALL-E 3' },
        ],
      },
    },
    {
      ...
      images: {
        create: [
          { url: '/prompts/02_rooftop_walkway.png', model: 'DALL-E 3' },
        ],
      },
    },
    {
      ...
      images: {
        create: [
          { url: '/prompts/03_basketball_cheer.png', model: 'DALL-E 3' },
        ],
      },
    },
    {
      ...
      images: {
        create: [
          { url: '/prompts/04_vr_headset.png', model: 'DALL-E 3' },
        ],
      },
    },
    {
      ...
      images: {
        create: [
          { url: '/prompts/05_martial_arts.png', model: 'DALL-E 3' },
        ],
      },
    },
    {
      ...
      images: {
        create: [
          { url: '/prompts/06_perler_bead.png', model: 'DALL-E 3' },
        ],
      },
    },
    {
      ...
      images: {
        create: [
          { url: '/prompts/07_picasso_portrait.png', model: 'DALL-E 3' },
        ],
      },
    },
    {
      ...
      images: {
        create: [
          { url: '/prompts/08_tokyo_map.png', model: 'DALL-E 3' },
        ],
      },
    },
    {
      ...
      images: {
        create: [
          { url: '/prompts/09_pixar_miniature.png', model: 'DALL-E 3' },
        ],
      },
    },
  ]
  ...
  for (const promptData of prompts) {
    await prisma.prompt.upsert({
      ...
      update: {
        ...
        images: {
          deleteMany: {},
          create: promptData.images.create,
        },
      },
      create: promptData,
    })
